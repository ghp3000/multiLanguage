...
func New(name, filename string) *Language {
	l := &Language{
		trans: translator.NewTranslator(name, filename),
	}
	return l
}
func (l *Language) RegisterDefaultTranslations(v *validator.Validate, trans ut.Translator) (err error) {
	translations := []struct {
		tag             string
		translation     string
		override        bool
		...
		},
		{
			...
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
				...
				case reflect.String:
					...
					t, err = ut.T("len-string", l.Field(fe), c)
				...
				case reflect.Slice, reflect.Map, reflect.Array:
					...
					t, err = ut.T("len-items", l.Field(fe), c)

				default:
					t, err = ut.T("len-number", l.Field(fe), ut.FmtNumber(f64, digits))
				}
		...
		},
		{
			...
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
				...
				case reflect.String:
					...
					t, err = ut.T("min-string", l.Field(fe), c)
				...
				case reflect.Slice, reflect.Map, reflect.Array:
					...
					t, err = ut.T("min-items", l.Field(fe), c)

				default:
					if fe.Type() == reflect.TypeOf(time.Duration(0)) {
						t, err = ut.T("min-number", l.Field(fe), fe.Param())
						goto END
					}
					...
					t, err = ut.T("min-number", l.Field(fe), ut.FmtNumber(f64, digits))
				}
		...
		},
		{
			...
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
				...
				case reflect.String:
					...
					t, err = ut.T("max-string", l.Field(fe), c)
				...
				case reflect.Slice, reflect.Map, reflect.Array:
					...
					t, err = ut.T("max-items", l.Field(fe), c)

				default:
					if fe.Type() == reflect.TypeOf(time.Duration(0)) {
						t, err = ut.T("max-number", l.Field(fe), fe.Param())
						goto END
					}
					...
					t, err = ut.T("max-number", l.Field(fe), ut.FmtNumber(f64, digits))
				}
		...
		},
		{
			...
			override:    false,
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
				t, err := ut.T(fe.Tag(), l.Field(fe), fe.Param())
				if err != nil {
		...
		},
		{
			...
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
				...
				case reflect.String:
					...
					t, err = ut.T("lt-string", l.Field(fe), c)
				...
				case reflect.Slice, reflect.Map, reflect.Array:
					...
					t, err = ut.T("lt-items", l.Field(fe), c)
				...
				case reflect.Struct:
					...
					t, err = ut.T("lt-datetime", l.Field(fe))
				...
				default:
					...
					t, err = ut.T("lt-number", l.Field(fe), ut.FmtNumber(f64, digits))
				}
		...
		},
		{
			...
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
				...
				case reflect.String:
					...
					t, err = ut.T("lte-string", l.Field(fe), c)
				...
				case reflect.Slice, reflect.Map, reflect.Array:
					...
					t, err = ut.T("lte-items", l.Field(fe), c)
				...
				case reflect.Struct:
					...
					t, err = ut.T("lte-datetime", l.Field(fe))
				...
				default:
					...
					t, err = ut.T("lte-number", l.Field(fe), ut.FmtNumber(f64, digits))
				}
		...
		},
		{
			...
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
				...
				case reflect.String:
					...
					t, err = ut.T("gt-string", l.Field(fe), c)
				...
				case reflect.Slice, reflect.Map, reflect.Array:
					...
					t, err = ut.T("gt-items", l.Field(fe), c)
				...
				case reflect.Struct:
					...
					t, err = ut.T("gt-datetime", l.Field(fe))
				...
				default:
					...
					t, err = ut.T("gt-number", l.Field(fe), ut.FmtNumber(f64, digits))
				}
		...
		},
		{
			...
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
				...
				case reflect.String:
					...
					t, err = ut.T("gte-string", l.Field(fe), c)
				...
				case reflect.Slice, reflect.Map, reflect.Array:
					...
					t, err = ut.T("gte-items", l.Field(fe), c)
				...
				case reflect.Struct:
					...
					t, err = ut.T("gte-datetime", l.Field(fe))
				...
				default:
					...
					t, err = ut.T("gte-number", l.Field(fe), ut.FmtNumber(f64, digits))
				}
		...
		},
		{
			...
			override:    false,
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
				s, err := ut.T(fe.Tag(), l.Field(fe), fe.Param())
				if err != nil {
					log.Printf("warning: error translating FieldError: %#v", fe)
					return fe.(error).Error()
				}
	...
	for _, t := range translations {
		if t.customTransFunc != nil && t.customRegisFunc != nil {
			...
			err = v.RegisterTranslation(t.tag, trans, t.customRegisFunc, l.translateFunc)
		} else {
			err = v.RegisterTranslation(t.tag, trans, registrationFunc(t.tag, t.translation, t.override), l.translateFunc)
		}
...
func (l *Language) Field(fe validator.FieldError) string {
	field := l.trans.Translate(fe.StructNamespace())
	if len(field) == 0 {
		return fe.Field()
	}
	return field
}
func (l *Language) translateFunc(ut ut.Translator, fe validator.FieldError) string {

	t, err := ut.T(fe.Tag(), l.Field(fe))
	if err != nil {
		log.Printf("warning: error translating FieldError: %#v", fe)
		return fe.(error).Error()
	}
...
// loadFieldsFile 将文本文件加载解析为map,文本文件每行内容:  key=value
